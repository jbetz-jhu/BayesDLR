...
bb_1_component_seed <- Sys.getenv(x = "bayes_dlr_bb_1_component_seed")
...
if(file.exists(processed_rdata_path)){
  ...
  bb_1_input_sha256 <-
    base::as.character(base::as.character(x = bb_1_input_sha256))

  bb_1_input_info <-
    file.info(processed_rdata_path)
  bb_1_input_size <- bb_1_input_info$size/2^(10)
  bb_1_input_mod_time <- bb_1_input_info$mtime

  bb_1_source_data_file <- input_file_information$input_data_file
  bb_1_source_data_sha256 <- input_file_information$input_sha256

  bb_1_input_file <- processed_rdata_file
} else{
...
output_file <-
  paste0(data_subfolder, "_", analysis_version_name,
         "_1-Component_Beta_Binomial_v", code_version, ".Rdata")
...
set.seed(seed = as.numeric(bb_1_component_seed))
...
bb_1_session_info <- utils::sessionInfo()

save(
  file = output_path,
  list =
    c("beta_binomial_1_component_mml",
      "ll.mbb",
      "bb.prevalence.ratio.mml",
      "analytic_data",
      "n_mc_samples",
      ...
      "bayes_dlr_sha256",
      "bb_1_component_seed",
      "bb_1_source_data_file",
      "bb_1_source_data_sha256",
      "bb_1_run_time",
      "bb_1_input_file",
      "bb_1_input_sha256",
      "bb_1_input_size",
